...
<body>
    ...
    <div class="main2">
        ...
        <form action="https://localhost/health_and_fitness_tracker/information3.php" method="post" name="verify">
            <input type="number" class="weight" name="weight" id="weight" placeholder="Enter your weight (in kg)"  max="300"
                required> <br><br>
            <input type="number" class="height" name="height" id="height" placeholder="Enter height (in cm)"  max="200" required> <br><br>
            <input type="number" class="age" name="age" id="age" min="13" max="100" placeholder="Enter your age" maxlength="100" required>
            <br><br><br>
